  ...
  "auto": {
    ...
    "hooks": {
      ...
      "useComposerState": {
        ...
        "folderWorkspaceCreateFailedMessage": "無法建立資料夾工作區。請檢視上方的錯誤詳細資訊，然後再試一次。",
    ...
    "components": {
      ...
      "settings": {
        ...
        "GitPane": {
          ...
          "2cde9044a8": "graphql",
          "36e3de3619": "這類指令不會與過時的歷史記錄比較。如果該分支有未提交的變更或僅存在於本機的 commit，Orca 會略過此更新。",
        ...
        "git": {
          "search": {
            ...
            "28192e3a63": "master",
            "e3e9adde59": "main",
            "0e993bf00f": "當你建立工作區時，Orca 會重新整理遠端基準，並安全地快轉你對應的本機分支，例如 main 或 master。這可避免像 git diff main...HEAD 這類指令與過期的歷史記錄比較。若該分支有未提交的變更或僅存在於本機的 commit，Orca 會略過此更新。",
            "f8bda25f29": "保持本機 main 為最新",
            "769ddd7f81": "自訂",
            ...
            "gitChanges": "git 變更",
            "compareAgainstUpstreamTitle": "預設比較基準",
            "compareAgainstUpstreamDescription": "選擇原始碼控制在比較已提交的變更時預設使用的基準。分支上游會自動跟隨目前的分支；若沒有上游，則回退到存放庫的預設分支。你仍可在對應 Worktree 的 Git 面板中，為各 Worktree 變更比較基準。Pull Request 與 rebase 目標不會改變。",
            "compareBase": "比較基準",
        ...
        "terminal": {
          ...
          "search": {
            ...
            "b2f52cb96c": "間距",
            "e8baf0d12c": "填入",
            "4655567c37": "CLI 網格周圍的垂直填入（以畫素為單位）。",
            "692c4ad032": "垂直內邊距",
            "75691e4911": "CLI 網格周圍的水平填入（以畫素為單位）。",
            "b4f182f24d": "水平填入",
            "6c2f9f05c8": "活力",
            "4f7f8f28ca": "透明度",
            "f6dd9ff606": "背景",
            ...
            "b5116e7b12": "如下",
            "f5d1e3d472": "重點",
            "17cc3ea102": "將滑鼠停留在 CLI 窗格上即可將其啟用，無需按一下。反映 Ghostty 的焦點跟隨滑鼠設定。選擇和視窗切換保持安全。",
            "c6178a2b4d": "焦點跟隨滑鼠",
            "f637a7dee9": "厚度",
            "e58d4040d0": "窗格分隔線的厚度。",
            "2d5ab88b7c": "分隔板厚度",
            ...
            "28ea41bd2d": "字型粗細",
            "b0bb76ae6b": "字型",
            "0acdc17891": "新窗格和即時更新的預設 CLI 字型系列。",
            "e989914ad6": "字型家族",
            "33031c1465": "文字大小",
            "0fe0073f0c": "新窗格和即時更新的預設 CLI 字型大小。",
            "5930244899": "字型大小",
          ...
          "windows": {
            "search": {
              ...
              "28ff08ed35": "視窗",
              "e7d2793b03": "CLI",
              "8ba875c132": "右鍵按一下將剪貼簿貼上到 CLI 中。使用 Ctrl+右鍵按一下開啟上下文選單。",
              "f0b8448570": "右鍵按一下貼上",
              "04994f6929": "預設",
              "fc564eadaf": "德比安",
              "4ee2579c32": "烏班圖",
            ...
            "action": {
              "recipe": {
                "options": {
                  ...
                  "resolveComments": "從所選的未解決 PR 或 MR 評論啟動 Agent。",
      ...
      "right": {
        "sidebar": {
          ...
          "ChecksPanel": {
            ...
            "ed3f79c031": "啟動 Agent 前請檢查提示詞。啟動後，所選的執行緒會被標記為已解決。",
            ...
            "495b2f8c4b": "已啟動 Agent，但無法將所選的評論標記為已解決。",
            "3c3ad3a1d2": "已啟動 Agent。所選的評論中沒有可在託管平臺上標記為已解決的評論。",
            "review": {
      ...
      "onboarding": {
        ...
        "OnboardingFlow": {
          ...
          "windowsTerminalSubtitle": "為新面板選擇預設 Shell，以及終端機中右鍵按一下的行為。"
        },
        "OnboardingFooter": {
          "ba58547306": "返回",
          "111d3f8d92": "跳至專案設定"
        ...
        "WindowsTerminalStep": {
          ...
          "rightClickPasteDescription": "右鍵按一下會貼上剪貼簿內容。Ctrl+右鍵按一下會開啟上下文選單。",
          "rightClickMenu": "開啟上下文選單",
          "rightClickMenuDescription": "右鍵按一下會開啟 CLI 選單。可從選單或鍵盤貼上。",
          "loading": "正在載入終端機設定…",
      ...
      "editor": {
        ...
        "IpynbViewer": {
          "859bf9fc21": "執行單元格",
          "7f0d7077c6": "取消",
          "10ed04a685": "筆記本單元在本機上從筆記本資料夾執行本機 Python。僅執行你信任的檔案中的單元。",
          "9e06ae5d36": "執行筆記本程式碼？",
          "d6f37a640b": "空筆記本",
          "8c3b21369a": "nb 格式",
          "329764e9fc": "BETA",
        ...
        "RichMarkdownErrorBoundary": {
          "aad0998127": "重試",
          "4a5de9f2f0": "切換到源模式，或按一下「重試」以重新載入豐富檢視。",
      ...
      "crash": {
        "report": {
          "CrashReportDialog": {
            ...
            "ead6fc0510": "沒有捕獲到自動當機報告。你仍然可以傳送詳細資訊，並在可用時包含最近的診斷記錄檔。",
