...
const zhTW = {
  ...
  "auto": {
    ...
    "store": {
      "slices": {
        ...
        "github": {
          ...
          "83f9b126ad": "Issue 型別只能在 Issue 上設定。",
          "f963485d37": "找不到該列",
          "a967f23983": "專案檢視未載入",
          "87020f6605": "該列沒有擁有者/存放庫/編號 — 無法修補底層專案",
        ...
        "worktrees": {
          ...
          "fa9299a66f": "您的新 Worktree 是最新的，但本機 {{value0}} 落後 {{value1}} {{value2}}。AI diff 可能會遺漏近期的 commits。",
    ...
    "components": {
      ...
      "GitHubItemDialog": {
        ...
        "4b390bd50d": "已停用自動合併",
        "a35ea5a0f6": "已啟用自動合併",
        "aba792c8b3": "合併 Pull Request 失敗",
        "dbe5e2448e": "Pull Request 已合併",
        "a27ee5ca1a": "這將更新 GitHub 上的 Pull Request。",
        "03d7216d62": "{{value0}} PR #{{value1}}？",
        "e9b7cb7d17": "{{value0}} PR 失敗",
        "bd3b4492a0": "Pull Request 已重新開啟",
        "9f88657c4e": "Pull Request 已關閉",
        "b6f1b7adbd": "這將在 GitHub 上重新開啟 Pull Request。",
        "de45fedf7b": "這將關閉 GitHub 上的 Pull Request。",
        "5a94f3d0e9": "尚無留言。",
        "1506916c09": "留言",
        "9b9cb55994": "未提供描述。",
        "52b20b56f7": "描述",
        ...
        "2e69540652": "已移除審查者",
        "69515bff81": "已移除審查者",
        "b4af16bf43": "此 pull request 沒有可用的存放庫脈絡。",
        "c42d942b75": "要求審查者失敗",
        "c016e4bac3": "已要求審查者",
        "ea985e657f": "已要求審查者",
      ...
      "LinearIssueWorkspace": {
        "ad5dec37b7": "從選取的 Issue 預覽、編輯並開始工作。",
        "c23e79e5c0": "動作",
        "b0eac92d85": "重試",
      ...
      "TaskPage": {
        ...
        "33fc2bcb30": "使用 Jira Cloud 站臺 URL、Atlassian 電子郵件與 API 權杖來瀏覽 Issue。",
      ...
      "UpdateCard": {
        ...
        "47126bcf57": "手動下載",
        "3553a8672f": "最後一個錯誤",
        "90559b14e3": "這會在重新啟動後啟用整個處理程式範圍的 Electron 網路開關。適用於拒絕 HTTP/2 更新下載的企業 VPN 或 Agent 伺服器。",
        "6e45bfa2e0": "正在下載...",
        "558842597d": "正在下載更新",
        "f58b5c57a6": "新增：",
        "ec8fe71cfc": "更新",
      ...
      "WorktreeJumpPalette": {
        ...
        "739bda980c": "主要",
        "556e7232ca": "目前",
        "684e8d7bc2": "正在收集您最近的 Worktree 和已開啟的分頁。",
        "ff908adfe9": "正在載入跳轉目標",
        ...
        "projectBadge": "專案",
        "repoGroupBadge": "存放庫群群組"
      },
      "github": {
        "pr": {
          "merge": {
            "state": {
              "a80132573b": "GitHub 仍在計算此 Pull Request 的 merge 狀態",
              "f958920f3a": "檢查中",
        ...
        "project": {
          ...
          "ProjectViewWrapper": {
            ...
            "1aa7c952b9": "專案檢視",
            "f352abf7c3": "存放庫清單更新中。",
            "1ce21b8cff": "此專案不在選取的存放庫範圍內。",
            "030de75bc5": "此專案符合多個選取的存放庫。"
          },
          "slug": {
            "dialog": {
              "AssigneesEditor": {
      ...
      "workspace": {
        ...
        "cleanup": {
          "WorkspaceCleanupDialog": {
            ...
            "a19040cd67": "沒有符合所選存放庫的非活動工作區。",
            "97c772c4fe": "在已檢查的存放庫中找不到非活動工作區。",
      ...
      "status": {
        "bar": {
          ...
          "ResourceUsageStatusSegment": {
            ...
            "e7ccce7e87": "系統 RAM",
            "9e2525c89f": "Orca 及各 Worktree 終端機下處理程式所持有的常駐記憶體。",
      ...
      "sidebar": {
        ...
        "NonGitFolderDialog": {
          "e52454b7f6": "以資料夾開啟",
          "05b33a17a9": "取消",
          "8fba4b8cbb": "此資料夾不是 Git 存放庫。您可以使用編輯器、終端機和搜尋，但無法使用以 Git 為基礎的功能。",
        ...
        "SetupScriptPromptCardViews": {
          ...
          "31b8b01a45": "設定",
          "4a98f907ae": "重試",
          "0a98169776": "新增在 Orca 建立新 Worktree 時執行的設定指令。",
          "8349e3fa4c": "。儲存後即可在新 Worktree 執行。",
          "b56d1322f7": "找到設定指令，位於",
          "aef6c0a213": "儲存偵測到的指令，即可在 Orca 每次建立 Worktree 時執行。",
            ...
            "local": {
              "start": {
                "actions": {
                  ...
                  "fb4fc5380e": "本機專案、Git 存放庫，或套件含多個存放庫的資料夾",
                  "2281fdc8c7": "瀏覽資料夾",
        ...
        "HostRemoveDialog": {
          ...
          "advanced": "進階",
          "alsoDeleteRemoteHint": "永久刪除遠端 Git Worktree 及其分支。此操作無法復原。",
          "alsoForgetLocalHint": "僅從 Orca 中清除。遠端檔案、Worktree 和分支不受影響。"
        },
        "HostRenameDialog": {
          "1a2b3c4d5e": "重新命名主機",
        ...
        "SuppressExternalWorktreeInboxDialog": {
          ...
          "6e91b3c4d2": "{{value0}} 的外部 Worktree 將不再顯示在側邊欄或此清單中，套件括之後建立的 Worktree。",
      ...
      "settings": {
        ...
        "BrowserUseComputerUseNotice": {
          ...
          "79209b37b9": "若 cookie 匯入不適合，Computer Use 可控制本機應用程式，並在適用時沿用現有的已登入瀏覽器工作階段。請安裝 Computer Use 技能；macOS 還需要隱私權權限。",
        ...
        "CliSection": {
          ...
          "38edbb5721": "Shell 命令",
          "6930feda9e": "從終端機使用 Orca 開啟應用程式、管理 Worktree 並與 Orca CLI 互動。",
          "c5c0f2641d": "Orca CLI",
        ...
        "CommitMessageAiPane": {
          ...
          "b27b0809f3": "開啟編輯器時執行一次託管審查詳細資料產生。",
          "d5f0de6309": "開啟 Create PR 時產生詳細資料",
        ...
        "GitPane": {
          "d2eede4c54": "為 commit、PR 和 Issue 加上 Orca 署名。",
          "e02ea23a32": "Orca 署名",
          "e71ce09c42": "orca",
          "b9b5771bb1": "署名",
          "b5f534717a": "共同撰寫",
          ...
          "2cde9044a8": "graphql",
          "36e3de3619": "這類別別別指令不會與過時的歷史記錄比較。如果該分支有未提交的變更或僅存在於本機的 commit，Orca 會略過此更新。",
          ...
          "compareAgainstUpstreamDescription": "選擇原始碼控制在比較已提交的變更時預設使用的基準。分支上游會自動跟隨目前的分支，若沒有上游則會回退到存放庫的預設分支。你仍可在各 Worktree 的 Git 面板中，為該 Worktree 變更比較基準。Pull Request 和 rebase 的目標不會改變。",
        ...
        "IntegrationsPane": {
          ...
          "4831ba1083": "重新檢查",
          "01f6c7582e": "了解更多",
          "1a62c295c6": "Gitea 憑證已設定，但無法透過驗證。請檢查 token、API 基底 URL 和存放庫權限；若環境變數有變更，請重新啟動 Orca。",
          ...
          "4ab9b96925": "Gitea",
          "953b7bf6f7": "Azure DevOps 憑證已設定，但無法透過驗證。請檢查 token、API 基底 URL 和存放庫權限；若環境變數有變更，請重新啟動 Orca。",
          ...
          "3c3cf05c63": "Bitbucket 憑證已設定，但無法透過驗證。請檢查 token 與存放庫權限，若環境變數有變更，請重新啟動 Orca。",
        ...
        "MobileEmulatorAgentControlRow": {
          ...
          "8af7a8bc38": "指令會以目前 Worktree 的作用中模擬器為目標。座標以 0..1 標準化。",
          "c7f3fe0a6e": "常用模擬器指令",
        ...
        "RepositoryHooksSection": {
          ...
          "52b31baf02": "設定指令碼",
          "8567127a40": "在 Worktree 建立或封存時執行的指令碼。本機指令碼儲存在這臺機器上；`orca.yaml` 指令碼會與您的團隊共用。",
        ...
        "developer": {
          "permissions": {
            "search": {
              ...
              "4438f81bfa": "檔案",
              "c10e36cbd1": "完整取用磁碟",
              "05ab708ee5": "開啟 macOS 隱私權權面板，以取用受保護的專案與 Worktree 檔案。",
              "bbf543a3a1": "完整取用磁碟",
              "7f145a3984": "視窗",
              "5610022e1e": "自動化",
              "0a467b750e": "螢幕截圖",
        ...
        "git": {
          "search": {
            ...
            "28192e3a63": "master",
            "e3e9adde59": "main",
            "0e993bf00f": "當您建立工作區時，Orca 會重新整理遠端基準，並安全地快轉您對應的本機分支，例如 main 或 master。這可避免像 git diff main...HEAD 這類別別別指令與過期的歷史記錄比較。若該分支有未提交的變更或僅存在於本機的 commit，Orca 會略過此更新。",
            "f8bda25f29": "保持本機 main 為最新",
            "769ddd7f81": "自訂",
            ...
            "gitChanges": "git 變更",
            "compareAgainstUpstreamTitle": "預設比較基準",
            "compareAgainstUpstreamDescription": "選擇原始碼控制在比較已提交的變更時預設使用的基準。分支上游會自動跟隨目前的分支；若沒有上游，則回退到存放庫的預設分支。您仍可在對應 Worktree 的 Git 面板中，為各 Worktree 變更比較基準。Pull Request 與 rebase 目標不會改變。",
            "compareBase": "比較基準",
        ...
        "jira": {
          "integration": {
            "card": {
              "8ff73fef62": "Jira token 由活動執行時加密並儲存在本機。重新輸入相同的站點 URL 和電子郵件將取代該站點的 API token。",
        ...
        "mobile": {
          ...
          "pane": {
            "search": {
              ...
              "b34ad5b3a7": "CLI",
              "6db86f445f": "行動裝置",
              "707fc78052": "選擇關閉應用程式或切換離開後，您在手機裝置上檢視的 CLI 會發生什麼情況。",
        ...
        "repository": {
          "search": {
            ...
            "4c17787d7b": "檔案",
            "8655e3387b": "掛鉤",
            "acd1157f0c": "在歸檔 Worktree 之前執行的本機和共用指令碼。",
            "bce0ca23c6": "存檔指令碼",
            "491b05d6e6": "設定命令",
            "a31b43a7f8": "設定指令碼",
            "5590388dfa": "設定",
            "baaf70bb37": "建立新 Worktree 後執行的本機和共用指令碼。",
            "b79df26937": "設定指令碼",
        ...
        "terminal": {
          "clipboard": {
            "search": {
              ...
              "9dfc125cd3": "作業系統 52",
              "62d1208b90": "振盪器 52",
              "459fea094a": "讓 CLI 中的程式透過 OSC 52（套件括透過 SSH）複製到系統剪貼簿。",
              ...
              "c38c18be15": "選擇",
              "797fdfe4ca": "選擇",
              "603818e8d8": "一旦做出選擇，就會自動將 CLI 選擇複製到剪貼簿。",
              "3bdc84f059": "選擇時複製"
            }
          },
          "search": {
            ...
            "b2f52cb96c": "間距",
            "e8baf0d12c": "填充",
            "4655567c37": "CLI 網格周圍的垂直填充（以畫素為單位）。",
            "692c4ad032": "垂直內邊距",
            "75691e4911": "CLI 網格周圍的水平填充（以畫素為單位）。",
            "b4f182f24d": "水平填充",
            "6c2f9f05c8": "活力",
            "4f7f8f28ca": "透明度",
            "f6dd9ff606": "背景",
            "71eb45e293": "模糊",
            "0838b3717b": "窗戶",
            "bc2054657a": "將背景模糊應用到 CLI 視窗。需要重新啟動。",
            "72d0482137": "視窗模糊",
            "7db59c4738": "阿爾法",
            "46d99ef4bb": "不透明度",
            "4c643695aa": "控制 CLI 背景的透明度。",
            "b36fd2416d": "背景不透明度",
            "d4daf4f612": "解凍",
            "88561b3499": "冷凍的",
            "0a05629060": "還原",
            ...
            "yaml_import": {
              "title": "從 YAML 匯入",
              "description": "將主題 YAML 檔案匯入為 Orca CLI 主題。",
              "keyword_yaml": "yaml",
              "keyword_custom": "自訂"
            },
            "4cec42dbf7": "國際",
            ...
            "1d89457764": "淺色主題",
            "da864e6cec": "燈光模式",
            "f268092ee3": "淺色模式可以使用自己的 CLI 主題。",
            "match_dark_mode_title": "匹配深色模式",
            "f785374072": "深色",
            "9c32726f47": "控制深色模式下窗格之間的分割分隔線。",
            "8987db7ff2": "深色分隔線顏色",
            "13f6310dd3": "選擇深色模式下使用的 CLI 主題。",
            "ec07ce9b02": "深色主題",
            "f036794286": "活躍",
            "846a7a1204": "窗格",
            "d1fa00a9cb": "徘徊",
            "b5116e7b12": "如下",
            "f5d1e3d472": "重點",
            "17cc3ea102": "將滑鼠停浮在 CLI 窗格上即可將其啟用，無需單擊。反映 Ghostty 的焦點跟隨滑鼠設定。選擇和視窗切換保持安全。",
            "c6178a2b4d": "焦點跟隨滑鼠",
            "f637a7dee9": "厚度",
            "e58d4040d0": "窗格分隔線的厚度。",
            "2d5ab88b7c": "分隔板厚度",
            "6c4c85ba43": "調光",
            "18dd5026c6": "不透明度應用於目前不活動的窗格。",
            ...
            "58da1ae45d": "字型連字",
            "7341e3d00e": "行高",
            "36a1b38bc8": "控制 CLI 線高度乘數。",
            "0f2fb0cb74": "行高",
            "20ce287cc6": "重量",
            "98c18f2c77": "控制 CLI 文字字型粗細。",
            "28ea41bd2d": "字型粗細",
            "b0bb76ae6b": "字型",
            "0acdc17891": "新窗格和實時更新的預設 CLI 字型系列。",
            "e989914ad6": "字型家族",
            "33031c1465": "文字大小",
            "0fe0073f0c": "新窗格和實時更新的預設 CLI 字型大小。",
            "5930244899": "字型大小",
            "ask_before_closing_running_terminals_title": "關閉執行中的 CLI 前詢問",
            "ask_before_closing_running_terminals_description": "在關閉有執行中命令或 Agent 的終端機前顯示確認。",
            "scrollSpeed": {
              "title": "捲動速度",
              "description": "調整普通 CLI 還原、修飾鍵快速捲動以及全屏 TUI 滾輪速度。"
            },
            "theme_target": {
              "title": "主題模式",
              "keyword_target": "目標",
          ...
          "windows": {
            "search": {
              ...
              "28ff08ed35": "視窗",
              "e7d2793b03": "CLI",
              "8ba875c132": "右鍵單擊將剪貼簿貼上到 CLI 中。使用 Ctrl+右鍵單擊開啟上下文選單。",
              "f0b8448570": "右鍵單擊貼上",
              "04994f6929": "預設",
              "fc564eadaf": "德比安",
              "4ee2579c32": "烏班圖",
              ...
              "02c772582a": "作業系統",
              "6e3adf4cba": "wsl",
              "978457945b": "選擇新建 WSL 終端機和本機 Agent 掃描所使用的 WSL 發行版。",
              "1f402b3651": "WSL 分佈",
              "d57f870938": "高階",
              "4af2f7526e": "版本",
              "d414022016": "pwsh",
              ...
              "41a69bc24d": "選擇新建 CLI 視窗時，PowerShell CLI 選項是使用 Windows PowerShell 還是 PowerShell 7+ 啟動。",
              ...
              "6cd20b9e64": "指令",
              "7c7056940a": "shell",
              "713c4a2f92": "為 Windows 上的新 CLI 窗格選擇預設 Shell。",
              "13715f9d23": "預設 Shell"
            }
          }
        },
          ...
          "tracker": {
            "integration": {
              "cards": {
                ...
                "8b2408a8e5": "此執行時已連線 Jira。如果已連線的站點清單看起來過期，請重新檢查。",
                ...
                "cef18762a2": "用 Linear 設定裡的個人 API 金鑰新增存取權限。完全存取金鑰可看到金鑰所有者能存取的所有團隊。",
                "6224fe9d34": "每個已連線的 Linear 工作區都有一個由活動執行時儲存的金鑰。全權限金鑰可覆蓋金鑰所有者可存取的所有團隊；受限金鑰可隨時更換。",
                ...
                "disconnect_all": "斷開連線",
                "account_scope_prefix": "帳號範圍",
                "2d60ec7921": "使用 API token 連線 Jira Cloud 站點，或使用個人存取權杖或使用者名稱和密碼連線自託管 Jira。認證會傳送到所選遠端執行時並以執行時支援的加密方式儲存。",
                "977e360b71": "使用 API token 連線 Jira Cloud 站點，或使用個人存取權杖或使用者名稱和密碼連線自託管 Jira。認證儲存在本機，本機執行時儲存支援時會進行加密。"
              }
            }
          }
        },
            ...
            "control": {
              "integration": {
                "cards": {
                  "793a06e899": "重新檢查",
                  "1a9475dace": "了解更多",
                  "19fb419c12": "Gitea 認證已設定但無法透過驗證。請檢查 token、API 基礎 URL 和存放庫權限；如果環境變數已變更，請重新啟動 Orca。",
        ...
        "computerUseSummary": {
          ...
          "checkingDescription": "Orca 正在檢查電腦控制助手的 macOS 隱私權權限。",
          "unavailableTitle": "電腦控制不可用。",
          "unavailableDescription": "Computer Use 權限不可用，因為 {{value0}}。",
          "readyTitle": "電腦控制已就緒。",
          "readyDescription": "當你要求時，Agent 可以檢查並操作應用視窗。",
          "permissionsTitle": "完成設定以使用本機應用。",
          "permissionsRequired": "在 Agent 可操作應用視窗前需要 {{value0}} 項權限{{value1}}。"
        },
        ...
        "settingOwnership": {
          ...
          "sourceControlAiDefaults": "方案、提示和託管評審預設值由此使用者端共用；模型選擇和發現則限定在 Agent 執行的主機內。",
        ...
        "ProjectWindowsRuntimeSetting": {
          ...
          "wsl": "WSL",
          "selectDistro": "選擇發行版",
          "runtimeChangeHelp": "執行時變更應用於此專案的新終端機、Agent 檢查和技能發現。已有終端機保留其目前執行時。",
          ...
          "runtimeSessionWarning": "{{value0}}會繼續在目前執行時中執行。繼續前請等待任務完成或重新啟動 CLI。",
          "pendingRuntimeChange": "執行時變更待處理。應用後，新專案工作將使用所選執行時。",
          "cancel": "取消",
          "applyRuntimeChange": "應用執行時變更"
        },
            ...
            "skill": {
              "install": {
                "cta": {
                  ...
                  "description": "讓您的 Agent 讀取和編輯 Linear 任務。",
                  "copyCommand": "複製命令"
                }
              },
              "search": {
        ...
        "GrokAccountsSection": {
          ...
          "3325d996cb": "重新整理使用量",
          "a8f3e2c1b4": "每週額度",
          "b7e2d9f0a3": "與 CLI 中 grok /usage 螢幕顯示的每週額度百分比相同。",
          "c6d1a8f4e2": "{{when}} 重設",
      ...
      "right": {
        "sidebar": {
          ...
          "ChecksPanel": {
            ...
            "ed3f79c031": "啟動 Agent 前請檢查提示詞。啟動後，選中的執行緒會被標記為已解決。",
            ...
            "495b2f8c4b": "已啟動 Agent，但無法將選中的評論標記為已解決。",
            "3c3ad3a1d2": "已啟動 Agent。選中的評論中沒有可在託管平臺上標記為已解決的評論。",
            "review": {
          ...
          "CreatePullRequestDialog": {
            ...
            "7ef56f3efe": "建立為草稿",
            "0c9f9a568c": "支援 Markdown 格式。使用 AI 產生來自動填充您的變更。",
            "02b2ce911f": "說明（可選）",
            "1cd53359db": "描述",
            "68314b4369": "標題",
            "694550a610": "main",
          ...
          "CreatePullRequestGenerateButton": {
            ...
            "d47fd63012": "正在產生 {{value0}} 詳情。點選停止。",
          ...
          "SourceControl": {
            ...
            "03194cfff4": "本機工作階段狀態源自您在此處開啟的衝突。",
            "413a3ba113": "衝突",
            "27a50fe970": "評審衝突",
            "f6cb48b6fe": "用 AI 解決",
            "3eeccbb221": "已解決的檔案在離開實時衝突狀態後會還原正常變更。",
            ...
            "04a5d7239b": "此存放庫沒有受支援的網頁遠端函式程式庫",
            ...
            "createPrIntentGeneratingDetails": "正在產生審查詳情…",
            "createPrIntentBranchChangedDuringDetails": "產生審查詳情時分支已變更。請重試建立 PR。",
          ...
          "SourceControlAgentActionDialogForm": {
            ...
            "23280cbab1": "此範本不套件含 {basePrompt}，因此 Agent 不會收到 Orca 的預設提示詞。",
            "5421a96acb": "儲存並啟動 Agent",
            "6cefcdfba1": "稍後可以在原始碼管理 AI 設定中變更。",
          ...
          "checks": {
            "panel": {
              "content": {
                ...
                "73d0675356": "重新整理衝突細節...",
                "f5bc5c4cf1": "託管提供方報告存在衝突，但本機 Git 未能復現。請重新整理評審或推送分支以重新計算可合併性。",
              ...
              "review": {
                ...
                "git_error": {
                  "title": "無法檢查分支狀態",
                  "body": "Orca 無法從目前環境確認此分支的上游。請在釋出或建立 {{reviewLabel}} 之前重試。"
                },
                "unknown": {
                ...
                "skipped": {
                  "disconnected": {
                    "title": "主機已斷開連線",
                    "body": "此存放庫的執行主機已斷開連線，Orca 無法重新整理 {{reviewLabel}} 狀態。"
                  },
                  "bare": {
                    "title": "裸存放庫",
            ...
            "control": {
              ...
              "primary": {
                "action": {
                  ...
                  "41d4bcf157": "檢查 PR 狀態...",
                  "acce237921": "沒有可提交的內容。分支沒有可釋出的變更。",
                  ...
                  "d2a8c4e703": "此分支上沒有需要套件含在 {{value0}} 中的變更。",
          ...
          "pull": {
            "policy": {
              "notice": {
                ...
                "rebase": "重定基底 (Rebase)",
                "rebaseDescription": "在遠端分支之上重新應用本機提交。",
          ...
          "AiVaultSessionWorktree": {
            ...
            "noActiveWorktreeMatch": "沒有與此工作階段匹配的活動 Worktree。",
      ...
      "onboarding": {
        ...
        "FeatureSetupChecklist": {
          ...
          "399cf885c0": "Agent 編排",
          "c5292c409d": "按你的要求，Agent 可檢視應用視窗並操作本機應用。",
          "1ecfb490ac": "電腦控制",
          "01426f3a23": "Agent 可瀏覽網站、檢查頁面並完成瀏覽器任務。",
          "ea85d9e628": "Agent 瀏覽器操控",
        ...
        "IntegrationsStep": {
          ...
          "3a3e360289": "更多工來源",
          "80e3ce0bc9": "重新檢查",
          "04ef416712": "新增 Linear 存取",
          "dd9c186a8b": "新增工作區存取權限",
          "c91a5782f1": "已連線",
          "27743304b1": "Linear",
          ...
          "5c115cb713": "CLI 未安裝",
          "217beb0658": "GitHub",
          "4983ae7433": "使用個人 API 金鑰新增 Linear 存取權限。完全存取金鑰可顯示金鑰所有者可存取的全部團隊。",
        ...
        "WindowsTerminalStep": {
          ...
          "rightClickMenuDescription": "右鍵單擊會開啟 CLI 選單。可從選單或鍵盤貼上。",
          "loading": "正在載入終端機設定...",
          ...
          "rightClickBehaviorDescription": "選擇符合你在 Windows 上使用習慣的 CLI 滑鼠行為。"
        },
        "mac": {
          "notification": {
            "permission": {
      ...
      "mobile": {
        "MobileHero": {
          ...
          "da1d5e5ed0": "可用於",
          "ec0607bf66": "支援的手機平臺",
          "b4ccce5cb7": "從您的手機控制 Orca。當您離開辦公桌時，檢查 Agent、檢視變更並啟動任務。",
      ...
      "floating": {
        "terminal": {
          ...
          "FloatingTerminalOrchestrationDialog": {
            "f726054620": "使 Agent 能夠透過 Orca 傳遞上下文並協調工作。",
            "1cd3f8af64": "編排技能",
          ...
          "FloatingTerminalPanel": {
            ...
            "5ddc688c52": "“{{value0}}”有未儲存的變更。您想在關閉前儲存嗎？",
            "25d7817f79": "終端機"
          },
      ...
      "feature": {
        "wall": {
          "AgentCapabilitiesSetupAction": {
            "b8dc9dd8a2": "已安裝",
            "1b51644c2d": "讓 Agent 控制桌面、手機遊標、單擊並在任何應用程式中鍵入。",
            "362a07517d": "電腦控制",
            "5e8fe5a72d": "讓 Agent 直接存取 Orca 的瀏覽器，以便測試頁面、捕獲螢幕截圖並根據所見內容執行操作。",
          ...
          "FeatureTourPreview": {
            ...
            "5d6ee181b6": "開啟任意工作區即可回到它的終端機，然後拆分窗格執行測試、記錄檔和 Agent。"
          },
          "FeatureWallBody": {
            "25ec5356d6": "設定"
          },
          ...
          "agent": {
            "capability": {
              "setup": {
                "status": {
                  "8eccfcb314": "已安裝",
                  "21d4f79c93": "單擊安裝 CLI 和技能以開啟 macOS 存取設定",
        ...
        "tips": {
          ...
          "CliSkillSetupTerminal": {
            "1953e90447": "按 Enter 為您的 Agent 安裝 Orca CLI 編排技能。",
      ...
      "emulator": {
        "pane": {
          ...
          "MobileEmulatorAgentSetupGuide": {
            ...
            "72736b051f": "當您希望 Agent 控制此模擬器時，設定 Orca CLI + 技能。",
            "d10ae98046": "完成",
            "3756cbeca7": "暫不",
            "6d950431d2": "隱藏",
            "ebceac65a4": "設定",
          ...
          "MobileEmulatorAgentSetupGuideSteps": {
            ...
            "64fb057667": "教授 Agent 此工作區的 orca 模擬器命令。",
      ...
      "editor": {
        ...
        "EditorContent": {
          "56dba34e1a": "（在源模式下編輯）",
          "e4b074749d": "前言",
          "9640d1d3db": "預覽此差異的修改版本。切換到源模式以檢查變更。",
          "78541e254e": "二進位制檔案已變更",
          "c88c73a0d3": "載入差異...",
        ...
        "IpynbViewer": {
          "859bf9fc21": "執行單元格",
          "7f0d7077c6": "取消",
          "10ed04a685": "筆記本單元在本機上從筆記本資料夾執行本機 Python。僅執行您信任的檔案中的單元。",
          "9e06ae5d36": "執行筆記本程式碼？",
          "d6f37a640b": "空筆記本",
          "8c3b21369a": "nb 格式",
          "329764e9fc": "BETA",
        ...
        "ExternalFileChangeBanner": {
          "7c41e90d12": "此檔案在您有未儲存編輯時在磁碟上發生了變更。儲存將覆蓋較新的磁碟內容。",
          "3fa2b8d417": "從磁碟重新載入",
          "a95d02c644": "保留我的編輯",
          "5c02de9b31": "已從磁碟重新載入",
          "d1e830fa22": "復原",
      ...
      "contextual": {
        "tours": {
          "ContextualTourControl": {
            ...
            "02e8373219": "當您將此文字框留空時，會自動產生新名稱。",
      ...
      "browser": {
        "pane": {
          ...
          "BrowserPane": {
            ...
            "87eb75f7d2": "輸入有效的 http(s) 或本機主機 URL。",
            "27d863542c": "瀏覽器註解",
            "e48569ac6d": "無法存取該網站。",
            ...
            "a5dcd0fd1d": "確認",
            "777b5bc4ec": "單擊一個元素可為 Agent 新增反饋。",
      ...
      "automations": {
        ...
        "AutomationSetupDecisionField": {
          ...
          "18f000ad4e": "高階",
          "874b72195b": "當此自動化建立工作區時，使用與手動建立 Worktree 相同的方式準備——執行專案的設定並開啟其 CLI 分頁。"
        }
      },
      "agent": {
        "AgentCombobox": {
      ...
      "activity": {
        "ActivityPrototypePage": {
          ...
          "8de7c5beaa": "CLI 不可用",
          "866083500b": "拖動以調整大小",
          "443690186e": "調整活動執行緒清單的大小",
          "7cd632006b": "沒有 Agent 活動與這些篩選條件匹配。",
      ...
      "jira": {
        "connect": {
          "dialog": {
            ...
            "d785c42b8b": "使用 Jira Cloud 站點 URL、Atlassian 郵箱和 API token 來瀏覽 Issue。",
        ...
        "routing": {
          "preference": {
            "dialog": {
              ...
              "preview": "預覽",
              "keep": {
                "title": "繼續在 Orca 瀏覽器中開啟 CLI 連結？",
                "description": "或預設使用系統瀏覽器。",
                "orca": {
                  "button": "繼續使用 Orca"
                }
              },
              "title": "在 Orca 瀏覽器中開啟 CLI 連結？",
              "description": "用 Orca 瀏覽器開啟 CLI 連結，或繼續使用系統瀏覽器。",
              "link": {
                "label": "連結"
              },
              "orca": {
      ...
      "taskPageEmptyState": {
        ...
        "noGitLabIssuesDescription": "沒有 GitLab Issue 匹配此篩選器。",
      ...
      "orca": {
        "profiles": {
          "switcher": {
            ...
            "signout": "離開登入",
            "16e3681072": "新建本機設定檔案",
            "e3b91a3d90": "建立一個空設定檔案，用於分開管理專案和 Worktree。",
            "f322e1f4d6": "設定檔名稱",
            "cfa59f8ad1": "建立並切換",
            "b4f9d1125d": "本機",
            "4815f7d163": "切換設定檔案",
          ...
          "management": {
            ...
            "816ce624b6": "專案已複製",
            "2c45bda8d3": "管理設定檔案",
            "2db945e4a0": "將專案從目前設定檔案複製或移動到另一個本機設定檔案。",
  ...
  "components": {
    "native-chat": {
      ...
      "launchPromptNotDelivered": "未送達 — 請檢查 CLI"
    },
    "tab": {
      "bar": {
        "SortableTabContextMenu": {
    ...
    "agentSessionContinuation": {
      ...
      "context": "上下文",
      "modeFocused": "焦點續接（推薦）",
      "modeFocusedDescription": "使用最新進度和目前工作區，僅在需要時讀取更早的工作階段細節。",
      "modeFull": "完整工作階段記錄",
...
exports.app = zhTW.app;
exports.browser = zhTW.browser;
exports.settings = zhTW.settings;
exports.menu = zhTW.menu;
exports.tray = zhTW.tray;
exports.worktreeJumpPalette = zhTW.worktreeJumpPalette;
exports.auto = zhTW.auto;
